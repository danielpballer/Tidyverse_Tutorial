---
title: "MA206 Tidyverse Tutorial 21-2" 
...
```
<center>
![](westpoint.jpeg){width=4in}            ![](math.jpg){width=2in} 
</center>
...
First visit the <a href="https://cran.rstudio.com/" target="_blank">CRAN website</a>.  First select "Download R for Windows, followed by "install R for the first time."  You will then select "Download R 4.0.3 for Windows" which will download the install file to your computer.  

Second, visit  <a href="https://www.rstudio.com/products/rstudio/download/" target="_blank">the RStudio</a> website.  Select the "Download" under RStudio Desktop FREE.  This will automatically scroll you to the bottom of the page.  You can then select "RStudio-1.3.1093.exe" under **All Installers**.   
...
To see see how to combine these commands, check out the step-by-step walkthrough <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#using-tidyverse-to-explore-the-data">HERE.</a>
...
employed_under_150K%>%
  ...
  labs(x="Earnings (USD)",y="Count",title = "Histogram of Earnings by Sex")
```
You can find a step-by-step walkthrough of how to make the above histograms <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#using-ggplot2-to-explore-the-data">HERE.</a>


Continuing with multivariable thinking, lets visualize this data using three of our variables: Age, Sex, and Earnings.  Since Age and Earnings are both quantitative variables we will assign them to the x and y axis and make a scatter plot. We will also color our plot by the categorical variable Sex.  You can find a step-bystep walkthrough of how to make the below scatter plot <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#using-ggplot2-to-explore-the-data">HERE.</a>
...
You can find a step-by-step walkthrough of how to change lables and axix scales <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#using-ggplot2-functions-for-data-visualization">HERE.</a>
...
You can find a step-by-step walkthrough of how different themes can change our plot <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#using-ggplot2-functions-for-data-visualization">HERE.</a>
...
You can find a step-by-step walkthrough of how to create some additional ggplot objects <a href="https://evamaerey.github.io/ma206_tidyverse_code_movies/#additional-ggplot2-geometric-objects">HERE.</a>
